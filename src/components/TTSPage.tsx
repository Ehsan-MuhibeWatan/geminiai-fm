...
const Board = () => {
  ...
  return (
    <main className="flex-1 flex flex-col gap-3 w-full max-w-(--page-max-width) mx-auto">
      ...
      <Block title="Voice">
        <div className="grid grid-cols-12 gap-3">
          {VOICES.map((newVoice) => (
            <div
              key={newVoice}
              className="col-span-4 sm:col-span-3 md:col-span-2 lg:col-span-2 relative"
            >
              <Button
                block
                color="default"
          ...
          {/* Shuffle Button */}
          <div className="col-span-4 sm:col-span-3 md:col-span-2 lg:col-span-2">
            <Button
              block
              color="neutral"
              onClick={() => {
      ...
      {/* --- 2. VIBE SECTION (Physics Presets) --- */}
      <Block title="Vibe">
